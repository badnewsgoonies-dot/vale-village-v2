...
exports.TOWER_BACKGROUNDS = exports.BATTLE_BACKGROUNDS = exports.DEFAULT_BACKGROUND = void 0;
exports.getBackgroundPath = getBackgroundPath;
exports.getTowerFloorBackground = getTowerFloorBackground;
/** Default background when none is specified */
exports.DEFAULT_BACKGROUND = 'gs1/Kolima_Forest';
/**
...
function getBackgroundPath(backgroundId) {
    if (!backgroundId) {
        return exports.BATTLE_BACKGROUNDS[exports.DEFAULT_BACKGROUND] ?? DEFAULT_BG_PATH;
    }
    return exports.BATTLE_BACKGROUNDS[backgroundId] ?? exports.BATTLE_BACKGROUNDS[exports.DEFAULT_BACKGROUND] ?? DEFAULT_BG_PATH;
}
/**
 * Get a background ID for a tower floor number
 * Cycles through TOWER_BACKGROUNDS based on floor
 */
function getTowerFloorBackground(floorNumber) {
    // Skip rest floors (4, 8, 12, etc.) - they don't need backgrounds
    // Map floor numbers to background indices
    const index = (floorNumber - 1) % exports.TOWER_BACKGROUNDS.length;
    return exports.TOWER_BACKGROUNDS[index] ?? exports.DEFAULT_BACKGROUND;
}
