...
exports.getSpriteDef = getSpriteDef;
exports.hasSprite = hasSprite;
exports.getAllSpriteIds = getAllSpriteIds;
exports.getOverworldSprite = getOverworldSprite;
/**
 ...
 */
const PLAYER_OVERWORLD_SPRITES = {
    // Venus element
    adept: {
 ...
 */
function resolveBattleSprite(id) {
...
function getAllSpriteIds() {
    return Object.keys(exports.SPRITES);
}
/**
 * Get overworld sprite for a unit by ID and facing
 */
function getOverworldSprite(unitId, facing = 'down') {
    const mapping = PLAYER_OVERWORLD_SPRITES[unitId] ?? PLAYER_OVERWORLD_SPRITES['adept'];
    if (!mapping)
        return '/sprites/overworld/Isaac_Walk.gif';
    return ((facing === 'up' && mapping.up) ||
        (facing === 'left' && mapping.left) ||
        (facing === 'right' && mapping.right) ||
        mapping.down);
}
