...
exports.PORTRAIT_MAP = void 0;
exports.getPortraitSprite = getPortraitSprite;
exports.hasPortrait = hasPortrait;
exports.getMappedCharacters = getMappedCharacters;
/**
 ...
 */
function getPortraitSprite(name) {
    ...
    const exactMatch = exports.PORTRAIT_MAP[baseName] || exports.PORTRAIT_MAP[name];
    if (exactMatch) {
        return exactMatch;
    }
    // Try lowercase match
    const lowerName = baseName.toLowerCase();
    const lowerMatch = exports.PORTRAIT_MAP[lowerName] || exports.PORTRAIT_MAP[name.toLowerCase()];
    if (lowerMatch) {
        return lowerMatch;
    }
...
function hasPortrait(name) {
    return name in exports.PORTRAIT_MAP || name.toLowerCase() in exports.PORTRAIT_MAP;
}
/**
 * Get all mapped character names
 */
function getMappedCharacters() {
    return Object.keys(exports.PORTRAIT_MAP);
}
