...
exports.getEquipmentSpriteId = getEquipmentSpriteId;
const EQUIPMENT_ICON_OVERRIDES = {
    // Swords
 ...
 */
function getEquipmentSpriteId(equipment) {
    ...
    switch (equipment.slot) {
        case 'weapon': {
            if (lowerName.match(/axe/))
                category = 'axes';
            else if (lowerName.match(/staff|rod|wand|scepter/))
                category = 'staves';
            else if (lowerName.match(/mace|hammer/))
                category = 'maces';
            else
        ...
        case 'armor': {
            if (lowerName.match(/robe|dress/))
                category = 'robes';
            else if (lowerName.match(/shirt|vest|clothes|coat|tunic|garb|camisole/))
                category = 'clothing';
            else
                category = 'armor';
            break;
        ...
        case 'helm': {
            if (lowerName.match(/circlet|tiara/))
                category = 'circlets';
            else if (lowerName.match(/crown/))
                category = 'crowns';
            else if (lowerName.match(/cap|hat|hood/))
                category = 'hats';
            else
                category = 'helmets';
            break;
        ...
        case 'accessory': {
            if (lowerName.match(/robe|mantle|dress/))
                category = 'robes';
            else if (lowerName.match(/shield/))
                category = 'shields';
            else if (lowerName.match(/glove|gauntlet/))
                category = 'gloves';
            else if (lowerName.match(/bracelet|armlet/))
                category = 'bracelets';
            else
                category = 'rings';
            break;
