...
exports.ABILITY_ICON_MAP = void 0;
exports.getAbilityIconSprite = getAbilityIconSprite;
exports.hasAbilityIcon = hasAbilityIcon;
exports.getAbilityEffectSprite = getAbilityEffectSprite;
exports.getMappedAbilities = getMappedAbilities;
/**
 * Maps ability IDs to sprite IDs
 * Uses available icons from /sprites/icons/psynergy/ (214 icons available)
 */
exports.ABILITY_ICON_MAP = {
 ...
 */
function getAbilityIconSprite(abilityId) {
    return exports.ABILITY_ICON_MAP[abilityId] || 'psynergy'; // Default to generic Psynergy icon
}
/**
 * Check if an ability has a mapped icon
 */
function hasAbilityIcon(abilityId) {
    return abilityId in exports.ABILITY_ICON_MAP;
}
/**
 * Convert an ability icon ID to a psynergy FX sprite path (GIF)
 * Returns null if no icon is mapped.
 */
function getAbilityEffectSprite(abilityId) {
    const iconId = exports.ABILITY_ICON_MAP[abilityId];
    if (!iconId)
        return null;
 ...
 */
function getMappedAbilities() {
    return Object.keys(exports.ABILITY_ICON_MAP);
}
