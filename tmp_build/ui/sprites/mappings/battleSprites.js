...
exports.KNOWN_ENEMY_BATTLE_UNITS = exports.KNOWN_PLAYER_BATTLE_UNITS = exports.EARLY_HOUSE_THRESHOLD = exports.EARLY_GAME_ENEMY_IDS = void 0;
exports.getPlayerBattleSprite = getPlayerBattleSprite;
exports.getEnemyBattleSprite = getEnemyBattleSprite;
exports.getEnemyBattleSpriteWithOverride = getEnemyBattleSpriteWithOverride;
...
function isEarlyEncounterId(encounterId) {
...
function collectEarlyEnemyIds() {
    const ids = new Set();
    for (const [encounterId, encounter] of Object.entries(encounters_1.ENCOUNTERS)) {
...
function makePlayerSpritePaths(character, weapon) {
...
exports.EARLY_GAME_ENEMY_IDS = collectEarlyEnemyIds();
exports.EARLY_HOUSE_THRESHOLD = EARLY_HOUSE_MAX;
/**
 * Resolve a player unit battle sprite.
 */
function getPlayerBattleSprite(unitId, state) {
 ...
 */
function getEnemyBattleSprite(enemyId, state) {
 ...
 */
function getEnemyBattleSpriteWithOverride(enemyId, state, overrideSpriteId) {
    if (overrideSpriteId) {
 ...
 */
exports.KNOWN_PLAYER_BATTLE_UNITS = Object.keys(PLAYER_SPRITES);
exports.KNOWN_ENEMY_BATTLE_UNITS = Object.keys(ENEMY_SPRITES);
