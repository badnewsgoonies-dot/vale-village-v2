...
exports.VILLAGE_WORLD_WIDTH = exports.VILLAGE_BUILDINGS = exports.HOUSES = exports.VALE_ARMORY = exports.BATTLE_TOWER = void 0;
...
exports.BATTLE_TOWER = {
    id: 'battle-tower',
    kind: 'tower',
    x: 100,
    y: constants_1.BUILDING_GROUND_Y,
...
exports.HOUSES = Array.from({ length: 30 }, (_, i) => {
...
exports.VILLAGE_BUILDINGS = [
    exports.BATTLE_TOWER,
    exports.VALE_ARMORY,
    ...exports.HOUSES,
];
/**
 * World width needed to scroll past the final house without clipping.
 * (Allows the last building to be centered in the viewport.)
 */
exports.VILLAGE_WORLD_WIDTH = (() => {
    const rightmost = Math.max(...exports.VILLAGE_BUILDINGS.map(b => b.x + b.width / 2));
    return rightmost + constants_1.VIEWPORT_WIDTH / 2;
})();
