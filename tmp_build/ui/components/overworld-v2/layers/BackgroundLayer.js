...
class BackgroundLayer {
    constructor() {
        ...
        Object.defineProperty(this, "mountainRanges", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "baseY", {
            ...
            writable: true,
            value: 256
        }); // Where mountains meet terrain (4/10 of 640px)
    ...
    generateMountainPoints(_variance, minHeight, maxHeight) {
        const points = [];
    ...
    updateMountainColors() {
        ...
        if (back.color !== oldColors[0])
            back.dirty = true;
        if (mid.color !== oldColors[1])
            mid.dirty = true;
        if (front.color !== oldColors[2])
            front.dirty = true;
    }
    render(ctx, camera) {
