...
class VillageLayer {
    constructor(buildings = villageLayout_1.VILLAGE_BUILDINGS) {
        ...
        Object.defineProperty(this, "playerX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "playerY", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "nearestDoor", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "glowTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "unlockedHouses", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set(['house-01', 'battle-tower', 'shop-vale-armory'])
        });
    ...
    render(ctx, camera) {
        for (const building of this.buildings) {
            ...
            const isVisible = camera.isVisible(building.x - building.width / 2, building.y - building.height, building.width, building.height, 200);
            if (!isVisible)
                continue;
            ...
            ctx.drawImage(sprite, screenX - building.width / 2, screenY - building.height, building.width, building.height);
    ...
    renderDoorGlow(ctx, screenX, screenY, building) {
        ...
        const gradient = ctx.createRadialGradient(screenX, screenY - building.height * 0.3, 0, screenX, screenY - building.height * 0.3, glowRadius);
        gradient.addColorStop(0, glowColor);
        gradient.addColorStop(1, 'rgba(0, 0, 0, 0)');
        ctx.fillStyle = gradient;
        ctx.beginPath();
        ctx.ellipse(screenX, screenY - building.height * 0.3, glowRadius, glowRadius * 0.7, 0, 0, Math.PI * 2);
        ctx.fill();
        ctx.restore();
    }
    /** Render "PRESS SPACE" prompt above the door */
    renderDoorPrompt(ctx, screenX, screenY, building) {
        const isLocked = !this.isUnlocked(building.id);
...
exports.VillageLayer = VillageLayer;
