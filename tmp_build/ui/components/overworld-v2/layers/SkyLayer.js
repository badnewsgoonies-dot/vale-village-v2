...
class SkyLayer {
    constructor() {
        ...
        Object.defineProperty(this, "cloudOffset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "skyHeight", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 256
        }); // Height of sky area (4/10 of 640px)
        /** Cached sky gradient colors */
        Object.defineProperty(this, "cachedColors", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { top: '#5090c0', bottom: '#90c8e8' }
        });
        /** Dirty flag - true when time of day changes require gradient recalculation */
        Object.defineProperty(this, "skyDirty", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
    ...
    lerpColor(color1, color2, t) {
        ...
        const r = Math.round((0, math_1.lerp)(r1, r2, t));
        const g = Math.round((0, math_1.lerp)(g1, g2, t));
        const b = Math.round((0, math_1.lerp)(b1, b2, t));
    ...
    drawClouds(ctx) {
        ...
        for (const cloud of this.clouds) {
            ...
            const gradient = ctx.createRadialGradient(cloud.x + cloud.width / 2, cloud.y + cloud.height / 2, 0, cloud.x + cloud.width / 2, cloud.y + cloud.height / 2, cloud.width / 2);
