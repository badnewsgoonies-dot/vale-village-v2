...
exports.SPEED_PRESETS = exports.ANIMATION_TIMING = void 0;
exports.getEventTiming = getEventTiming;
 ...
 */
function getEventTiming(eventType, _isGifCached) {
    const base = exports.ANIMATION_TIMING;
    switch (eventType) {
        case 'ability':
