...
const OverworldMapV3 = () => {
    ...
    if (!spritesLoaded) {
        return ((0, jsx_runtime_1.jsx)("div", { style: { padding: '2rem', color: '#fff', textAlign: 'center' }, children: "Loading sprites..." }));
    }
    return ((0, jsx_runtime_1.jsxs)("div", { className: "overworld-v3-container", children: [(0, jsx_runtime_1.jsxs)("div", { className: "overworld-v3-stage", style: { width: `${width}px`, height: `${height}px` }, children: [(0, jsx_runtime_1.jsx)("canvas", { ref: bgCanvasRef, width: width, height: height, className: "overworld-v3-layer overworld-v3-bg" }), (0, jsx_runtime_1.jsx)("canvas", { ref: entityCanvasRef, width: width, height: height, className: "overworld-v3-layer overworld-v3-entities" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { padding: '1rem', color: '#fff', textAlign: 'center' }, children: ["Grid-based rendering: tiles[", playerRef.current.row, "][", playerRef.current.col, "]", (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("small", { children: "NO manual X/Y coordinates - all positions auto-calculated!" })] })] }));
};
exports.OverworldMapV3 = OverworldMapV3;
