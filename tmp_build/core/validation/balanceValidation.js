...
exports.validateContentBalance = validateContentBalance;
exports.formatBalanceWarnings = formatBalanceWarnings;
/**
 * Validate all content balance
 * Returns array of warnings (empty if no issues)
 */
function validateContentBalance(content) {
    const warnings = [];
    // Validate enemies
 ...
 */
function validateEnemyBalance(id, enemy) {
    const warnings = [];
 ...
 */
function validateAbilityBalance(id, ability) {
    const warnings = [];
 ...
 */
function validateEquipmentBalance(id, equipment) {
    const warnings = [];
 ...
 */
function validateEncounterBalance(id, encounter, enemyDefinitions) {
    const warnings = [];
 ...
 */
function formatBalanceWarnings(warnings) {
