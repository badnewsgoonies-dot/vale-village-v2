...
exports.calculateBattleRewards = calculateBattleRewards;
exports.calculateStatGains = calculateStatGains;
 ...
 */
function calculateBattleRewards(encounterId, partySize, survivorCount) {
 ...
 */
function calculateStatGains(unit, oldLevel, newLevel) {
 ...
 */
function distributeRewards(team, rewards) {
    const levelUps = [];
    const updatedUnits = [];
    ...
    for (const unit of team.units) {
        ...
        const xpResult = (0, xp_1.addXp)(unit, rewards.xpPerUnit);
