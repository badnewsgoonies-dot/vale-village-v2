...
exports.DJINN_SUMMON_DAMAGE = void 0;
exports.calculateDjinnSynergy = calculateDjinnSynergy;
exports.getSetDjinnIds = getSetDjinnIds;
exports.calculateSummonDamage = calculateSummonDamage;
exports.canActivateDjinn = canActivateDjinn;
exports.getDjinnReadyForRecovery = getDjinnReadyForRecovery;
/**
 * Summon damage values based on number of Djinn activated
 * From QUEUE_BATTLE_SYSTEM_PLAN.md
 */
exports.DJINN_SUMMON_DAMAGE = {
 ...
 */
function calculateDjinnSynergy(djinnElements) {
 ...
 */
function calculateSummonDamage(djinnCount) {
    return exports.DJINN_SUMMON_DAMAGE[djinnCount];
}
/**
 ...
 */
function canActivateDjinn(team, djinnId) {
 ...
 */
function getDjinnReadyForRecovery(team, currentRound) {
    return team.equippedDjinn.filter(djinnId => {
        const tracker = team.djinnTrackers[djinnId];
