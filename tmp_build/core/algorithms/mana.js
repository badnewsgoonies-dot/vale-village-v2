...
exports.canAffordAction = canAffordAction;
exports.getAbilityManaCost = getAbilityManaCost;
exports.calculateTotalQueuedManaCost = calculateTotalQueuedManaCost;
exports.validateQueuedActions = validateQueuedActions;
exports.isQueueComplete = isQueueComplete;
/**
 ...
 */
function canAffordAction(remainingMana, manaCost) {
 ...
 */
function getAbilityManaCost(abilityId, ability) {
    if (abilityId === null) {
 ...
 */
function calculateTotalQueuedManaCost(queuedActions) {
 ...
 */
function validateQueuedActions(remainingMana, queuedActions) {
 ...
 */
function isQueueComplete(queuedActions, teamSize) {
