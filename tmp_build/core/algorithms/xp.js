...
exports.addXp = addXp;
exports.calculateMaxHpAtLevel = calculateMaxHpAtLevel;
...
function addXp(unit, xpGain) {
    ...
    if (leveledUp) {
        for (let level = oldLevel + 1; level <= newLevel; level++) {
            const abilitiesAtLevel = unit.abilities.filter(a => a.unlockLevel === level);
 ...
 */
function calculateMaxHpAtLevel(baseHp, growthRate, level) {
