...
exports.RENTAL_TEAMS = void 0;
exports.getRentalTeamsForFloor = getRentalTeamsForFloor;
exports.getRentalTeamsByDifficulty = getRentalTeamsByDifficulty;
exports.getRentalTeamById = getRentalTeamById;
exports.calculateTeamMatchScore = calculateTeamMatchScore;
exports.getRecommendedRentalTeams = getRecommendedRentalTeams;
/**
 ...
 */
exports.RENTAL_TEAMS = [
    // Beginner Team 1: Balanced Mixed Elements
    {
        id: 'rental-starter-balanced',
        name: 'Starter Squad',
        description: 'Balanced team for beginners. Isaac leads with Garet providing damage and a Mystic for support.',
        theme: 'balanced',
        element: 'Mixed',
    ...
    // Beginner Team 2: Earth Defensive
    {
        ...
        description: 'Tanky Venus team focused on defense. High HP and DEF for sustained battles.',
        theme: 'defensive',
        element: 'Venus',
    ...
    // Beginner Team 3: Fire Offensive
    {
        ...
        name: 'Blaze Brigade',
        description: 'Aggressive Mars team with high damage output. Glass cannon strategy - defeat enemies quickly.',
        theme: 'offensive',
        element: 'Mars',
 ...
 */
function getRentalTeamsForFloor(floorNumber) {
    return exports.RENTAL_TEAMS.filter(team => floorNumber >= team.recommendedForFloors.min &&
 ...
 */
function getRentalTeamsByDifficulty(difficulty) {
    return exports.RENTAL_TEAMS.filter(team => team.difficulty === difficulty);
}
/**
 ...
 */
function getRentalTeamById(teamId) {
    return exports.RENTAL_TEAMS.find(team => team.id === teamId) ?? null;
}
/**
 ...
 */
function calculateTeamMatchScore(team, floorNumber, playerLevel) {
    let score = 0;
...
function getRecommendedRentalTeams(floorNumber, playerLevel, limit = 3) {
