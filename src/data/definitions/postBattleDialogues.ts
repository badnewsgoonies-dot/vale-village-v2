  ...
  nodes: [
    {
      ...
      portrait: 'isaac',
      nextNodeId: 'garet-celebrates',
    },
    {
      id: 'garet-celebrates',
      speaker: 'Garet',
      text: '*pumps fist* That Stone Captain thought he was tough! Did you see how my Fireball took him down?!',
      portrait: 'garet',
      nextNodeId: 'mia-heals',
    },
    {
      id: 'mia-heals',
      speaker: 'Mia',
      text: '*healing the party* Everyone okay? That was intense. Let me patch you up before we continue.',
      portrait: 'mia',
      nextNodeId: 'ivan-observes',
    },
    {
      id: 'ivan-observes',
      speaker: 'Ivan',
      text: 'Halfway through... but the Overseer will only send stronger forces now. Stay sharp, everyone.',
      portrait: 'ivan',
    },
  ],
};
  ...
  nodes: [
    {
      ...
      portrait: 'isaac',
      nextNodeId: 'garet-ecstatic',
    },
    {
      id: 'garet-ecstatic',
      speaker: 'Garet',
      text: '*throws arms up* VALE IS FREE! I can\'t believe it—we actually did it! Someone pinch me!',
      portrait: 'garet',
      nextNodeId: 'mia-emotional',
    },
    {
      id: 'mia-emotional',
      speaker: 'Mia',
      text: '*tears welling* All those people... all those creatures... finally free. This is what we fought for.',
      portrait: 'mia',
      nextNodeId: 'ivan-cautious',
    },
    {
      id: 'ivan-cautious',
      speaker: 'Ivan',
      text: '*smiles but looks distant* The Overseer mentioned masters... I sense this is only the beginning.',
      portrait: 'ivan',
      nextNodeId: 'sentinel-salutes',
    },
    {
      id: 'sentinel-salutes',
      speaker: 'Sentinel',
      text: '*salutes* It was an honor fighting alongside you all. Vale owes you everything.',
      portrait: 'sentinel',
    ...
    },
    {
      id: 'isaac-final',
      speaker: 'Isaac',
      text: '*looks at team* Whatever comes next... we face it together. But today? Today we celebrate!',
      portrait: 'isaac',
    },
  ],
};
  ...
  nodes: [
    {
      ...
      portrait: 'isaac',
      nextNodeId: 'garet-amazed',
    },
    {
      id: 'garet-amazed',
      speaker: 'Garet',
      text: '*jaw drops* That was... INCREDIBLE! Did you see the way all our elements combined at the end?!',
      portrait: 'garet',
      nextNodeId: 'mia-wisdom',
    },
    {
      id: 'mia-wisdom',
      speaker: 'Mia',
      text: 'The Nexus... it wasn\'t just a prison. It was a test. And we passed—together.',
      portrait: 'mia',
      nextNodeId: 'ivan-revelation',
    },
    {
      id: 'ivan-revelation',
      speaker: 'Ivan',
      text: '*wind swirling gently* I can feel it—the Psynergy of Weyard flowing freely again. We\'ve restored the balance.',
      portrait: 'ivan',
      nextNodeId: 'sentinel-honor',
    },
    {
      id: 'sentinel-honor',
      speaker: 'Sentinel',
      text: '*kneels briefly* From prisoner to protector... I never imagined I\'d help save the world itself.',
      portrait: 'sentinel',
      nextNodeId: 'stormcaller-lightning',
    },
    {
      id: 'stormcaller-lightning',
      speaker: 'Stormcaller',
      text: '*lightning arcs joyfully* The storms sing with freedom! Thirty houses—thirty victories! WE ARE LEGENDS!',
      portrait: 'stormcaller',
      nextNodeId: 'isaac-conclusion',
    },
    {
      id: 'isaac-conclusion',
      speaker: 'Isaac',
      text: '*looks at the sky* Whatever challenges lie ahead... with friends like these, nothing can stop us. To Weyard—and beyond!',
      portrait: 'isaac',
    },
  ],
};
